...
10. v0.1.10 canonical parts plus portable fitment packs: standardized service-position vocabulary, equipment descriptor matching/manual mapping, community compatibility matrix import/export, safe store links, activity part usage, and central cost entries;
