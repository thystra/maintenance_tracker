...
use OCA\MaintenanceTracker\Service\MaintenanceStatusService;
...
final class MaintenanceStatusController extends OCSController {
	...
	#[NoAdminRequired]
	#[ApiRoute(verb: 'GET', url: '/api/v1/assets/{assetUuid}/maintenance-status')]
